...
class FITSCutout(Cutout):
    ...
    def cutout(self, file_name, position, size, output_writer, extension=0):
        """
        Perform a Cutout of the given data at the given position and size.
        :param file_name:  The path to the FITS file.
        ...
        :param extension:   The extension to pull out of the FITS file.  Defaults to zero (0).
        """
